In the "source-archive\word2vec\trunk", the "demo-word.sh" file is changed to create vectors that we need. We add the "text8" file to "source-archive\word2vec\trunk". We add the "vocabglo" file to "source-archive\word2vec\trunk" and the "vocabglo" is copied from "vocab" of "GloVe-master/GloVe-master" which is created by GloVe.
